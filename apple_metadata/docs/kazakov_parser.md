Notes on the Kazakov.life parser (C++)
======================================

Much good information available here:
https://kazakov.life/2013/10/31/extracting-extended-attributes-from-apple-double-format/

Includes an example parser written in C++.
